...
interface SortableChipProps {
  template: AnyTemplate; position: 'above' | 'below';
  onSend: (t: AnyTemplate) => void; onUnpin: (id: string) => void;
}

const SortableChip: FC<SortableChipProps> = ({ template, position, onSend, onUnpin }) => {
  ...
  return (
    <div ref={setNodeRef}
      style={{
        ...
        padding: below ? '8px 16px' : '6px 12px',
        borderRadius: below ? 22 : 20, fontSize: below ? 13.5 : 12.5, fontWeight: 500,
...
/* PinnedTemplates: main component - ALL hooks before any early return */
